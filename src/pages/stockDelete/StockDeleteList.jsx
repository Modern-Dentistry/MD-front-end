    ...
    return (
        <div className="flex flex-col border border-gray-200 rounded-lg bg-white p-1">
            ...
            <div className="flex justify-between items-center gap-2 p-2">
                ...
                onClick={() => {navigate("/stock/delete/add")}}>
                    Yenisini əlavə et
                </button>
                <button className="">
                    <DownloadIcon />
            ...
            <SimpleList columns={columns} data={data} enableDelete={true} enableEdit={true} enableView={true} handleView={(id) => {navigate("/stock/delete/" + id)}} handleEdit={(id) => {navigate("/stock/delete/" + id + "/edit")}}/>
        </div>
    );
};
