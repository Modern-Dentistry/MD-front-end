      ...
      {showColorPicker && (
        ...
        <div className="form-group">
          ...
          <CustomDropdown
            ...
            options={[
              ...
              { value: 'periodontics', label: 'Paradontologiya' },
              { value: 'endodontics', label: 'Endodontiya' },
              { value: 'surgery', label: 'Cərrahiyyə' },
              { value: 'pediatric', label: 'Uşaq stomatologiyası' }
            ]}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <CustomDropdown
            ...
            options={[
              { value: 'dr1', label: 'Dr. Əli Məmmədov' },
              { value: 'dr2', label: 'Dr. Ayşə Əliyeva' },
              { value: 'dr3', label: 'Dr. Mehdi Hüseynov' },
              { value: 'dr4', label: 'Dr. Zəhra Quliyeva' }
            ]}
          />
        </div>
