    ...
    <div className={`sidebar-menu ${isCollapsed ? "collapsed" : ""}`}>
      ...
      <div className="menu-items">
        ...
        <button
          ...
          className="flex items-center ml-3 cursor-pointer mt-4 gap-2 px-4 py-2 bg-red-500 text-white font-semibold rounded-xl hover:bg-red-600 transition duration-300">
          <svg
